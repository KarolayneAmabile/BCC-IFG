...
```
karolayne@Karol:~/BCC-IFG/sistemas-operacionais/exemploD$ ./D-somaVetor1
>>> D-somaVetor1 <<<
Alocando memória para o vetor...
Gerando serialmente os números aleatórios...
Somando os elementos e guardando o resultado da soma em uma variável compartilhada...
Tempo gasto na soma 1.09041 segundos
Resultado da soma: 2.74982e+09

karolayne@Karol:~/BCC-IFG/sistemas-operacionais/exemploD$ ./D-somaVetor2
>>> D-somaVetor2 <<<
Alocando memória para o vetor...
Gerando serialmente os números aleatórios...
Digite o número desejados de threads a serem criadas (digite 0 para sair):
--> 4
Intervalo 0 -- [0 - 125000000)
Intervalo 1 -- [125000000 - 250000000)
Intervalo 2 -- [250000000 - 375000000)
Intervalo 3 -- [375000000 - 500000000)
Somando os elementos e guardando o resultado da soma em uma variável compartilhada...
Tempo gasto na soma 7.1298 segundos
Resultado da soma: 2.74982e+10
...
Como o meu computador possui 4 CPU's, a quantidade de threads ideal são 4.
